...
Default for `SUPNB001` (operator) = **C**. Default for `SUPNB002` +
...
Once SUPNB001 is at Profile C and SUPNB002/003 at Profile B:
...
| Default per laptop | SUPNB001 = C; SUPNB002 + SUPNB003 = B |
