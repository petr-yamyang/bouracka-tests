...
> **Zdroj:** `delivery/analytical/01_TESTPLAN-CS.md (CS author fills)`
...
(seznam sekcí podle zdrojového dokumentu — viz delivery/analytical/01_TESTPLAN-CS.md (CS author fills) v repozitáři)
