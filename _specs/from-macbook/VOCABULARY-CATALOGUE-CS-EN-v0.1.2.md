...
| Sections | 14 (testing core / defects / CAST framework canon / Test Management canon / CAST entities + lifecycle / methodology + VUP discipline / DVA architecture / SUPIN-Bouračka / MI-M-T-3FP / process-governance / ISTQB subset / application targets / OQs) |
| Total terms catalogued | ≈ 360 (after VUP + CAST harvest) |
| Sources synthesised | 8 (DVA-2016 + VUP HTML + CAST presentation + Test Management presentation + Test Plan templates + IIR 2009 kit + ISTQB CZ + ČSN + project-specific) |
| Open vocabulary questions | 10 (OQ-VOC-01 closed; -02..-07 open from v0.1.0; -08..-10 added v0.1.1) |
| First application iterations | CP-SUPIN-02 (Bouračka tester materials) + MIM-02 (mim2000.cz) + BLOG-02 (blog reorg) + ThinkPad delivery 2026-05-03 PM |
| Status | v0.1.1 — binding; cross-artefact application pass complete (CLIENT-PILOT-SUPIN, METHODOLOGY-MAPPING, recon templates, future-repo, ThinkPad handover archive); next refresh = OQ-VOC-08..10 resolution + Bouračka recon harvest |
